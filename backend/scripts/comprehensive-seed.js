...
const comprehensiveSeedData = async () => {
  try {
    ...
    console.log('⚠️  This will CLEAR all existing data and create comprehensive data.\n');
    ...
    // Create 20 diverse users with Goa-centric data
    const users = [
      {
      ...
      },
      {
        ...
        passwordHash: defaultPassword,
        name: 'Sarah Mitchell',
        bio: 'Dance instructor teaching salsa on Goas beaches 💃',
        age: 26,
        gender: 'Female',
        profilePicUrl: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150',
        location: { type: 'Point', coordinates: [73.7450, 15.4600] }, // Calangute
        interests: ['Dance', 'Music', 'Beach', 'Fitness'],
        budgetPreference: { min: 150, max: 500 },
        isMapPublic: true
      },
      {
        ...
        bio: 'Marine biologist studying Goas coral reefs 🐠',
        age: 34,
        gender: 'Male',
        profilePicUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150',
        location: { type: 'Point', coordinates: [73.7150, 15.4200] }, // Agonda
        interests: ['Marine Biology', 'Diving', 'Nature', 'Conservation'],
        budgetPreference: { min: 200, max: 600 },
        isMapPublic: true
      },
      {
        ...
        passwordHash: defaultPassword,
        name: 'Priyanka Joshi',
        bio: 'Local chef sharing traditional Goan recipes 👩‍🍳',
        age: 29,
        gender: 'Female',
        profilePicUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150',
        location: { type: 'Point', coordinates: [73.7650, 15.5100] }, // Panjim
        interests: ['Cooking', 'Food', 'Culture', 'Local'],
        budgetPreference: { min: 100, max: 400 },
        isMapPublic: true
      },
      {
        ...
        passwordHash: defaultPassword,
        name: 'Mike Chen',
        bio: 'Adventure sports instructor for water activities 🏄‍♂️',
        age: 31,
        gender: 'Male',
        profilePicUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150',
        location: { type: 'Point', coordinates: [73.7200, 15.4900] }, // Colva
        interests: ['Water Sports', 'Adventure', 'Teaching', 'Beach'],
        budgetPreference: { min: 200, max: 700 },
        isMapPublic: true
      },
      {
        ...
        passwordHash: defaultPassword,
        name: 'Emma Watson',
        bio: 'Environmental activist protecting Goas beaches 🌊',
        age: 27,
        gender: 'Female',
        profilePicUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150',
        location: { type: 'Point', coordinates: [73.7000, 15.3800] }, // Patnem
        interests: ['Environment', 'Conservation', 'Beach', 'Activism'],
        budgetPreference: { min: 100, max: 400 },
        isMapPublic: true
      }
    ];
    ...
    // Create comprehensive public itineraries
    const itineraries = [
      {
      ...
      },
      {
        ...
        title: 'Palolem Budget Backpacker Guide',
        totalBudget: 200,
        isPublic: true,
        departureDate: new Date('2024-12-05'),
        arrivalDate: new Date('2024-12-12'),
        blocks: []
      },
      {
        userId: createdUsers[11]._id,
        title: 'Fontainhas Art & Culture Walk',
        totalBudget: 300,
        isPublic: true,
        departureDate: new Date('2024-12-08'),
        arrivalDate: new Date('2024-12-08'),
        blocks: []
      },
      {
        userId: createdUsers[12]._id,
        title: 'Local Goan Hidden Gems Tour',
        totalBudget: 400,
        isPublic: true,
        departureDate: new Date('2024-12-22'),
        arrivalDate: new Date('2024-12-24'),
        blocks: []
      },
      {
        userId: createdUsers[13]._id,
        title: 'Assagao Wellness & Nature Retreat',
        totalBudget: 800,
        isPublic: true,
      ...
      },
      {
        ...
        title: 'Porvorim Tech & Startup Meetup',
        totalBudget: 600,
        isPublic: true,
        departureDate: new Date('2024-12-15'),
        arrivalDate: new Date('2024-12-17'),
      ...
      {
        userId: createdUsers[15]._id,
        title: 'Calangute Beach Salsa & Dance',
        totalBudget: 350,
        isPublic: true,
        departureDate: new Date('2024-12-19'),
        arrivalDate: new Date('2024-12-21'),
        blocks: []
      },
      {
        userId: createdUsers[16]._id,
        title: 'Agonda Marine Biology & Diving',
        totalBudget: 900,
        isPublic: true,
        departureDate: new Date('2024-12-10'),
        arrivalDate: new Date('2024-12-17'),
      ...
      {
        userId: createdUsers[17]._id,
        title: 'Panjim Traditional Cooking Class',
        totalBudget: 250,
        isPublic: true,
        departureDate: new Date('2024-12-13'),
        arrivalDate: new Date('2024-12-13'),
        blocks: []
      },
      {
        userId: createdUsers[18]._id,
        title: 'Colva Water Sports & Adventure',
        totalBudget: 500,
        isPublic: true,
        departureDate: new Date('2024-12-11'),
        arrivalDate: new Date('2024-12-14'),
        blocks: []
      },
      {
        userId: createdUsers[19]._id,
        title: 'Patnem Beach Conservation & Cleanup',
        totalBudget: 200,
        isPublic: true,
        departureDate: new Date('2024-12-07'),
        arrivalDate: new Date('2024-12-09'),
        blocks: []
      }
    ];
    ...
    // Create comprehensive blocks for all itineraries
    const blocks = [
    ...
    for (let i = 0; i < createdItineraries.length; i++) {
      const blocksForItinerary = createdBlocks.filter(block => 
        block.itineraryId.toString() === createdItineraries[i]._id.toString()
      );
      await Itinerary.findByIdAndUpdate(createdItineraries[i]._id, {
        blocks: blocksForItinerary.map(block => block._id)
      });
    }

    // Create comprehensive feed content (50+ posts)
    const feedContent = [
      // Beach and Nature Posts
      {
        userId: createdUsers[0]._id,
        type: 'Post',
      ...
      },
      {
        userId: createdUsers[16]._id,
        type: 'Post',
        text: 'Diving in Agonda waters today! The marine life here is incredible 🐠 #Diving #MarineLife #Agonda',
        locationTag: 'Agonda, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[19]._id,
        type: 'Post',
        text: 'Beach cleanup at Patnem today! Every small action counts for our oceans 🌊 #Conservation #BeachCleanup #Patnem',
        locationTag: 'Patnem, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      
      // Food and Culture Posts
      {
        userId: createdUsers[4]._id,
        type: 'Post',
      ...
      },
      {
        userId: createdUsers[17]._id,
        type: 'Post',
        text: 'Teaching traditional Goan cooking today! The secret is in the spices 👩‍🍳 #Cooking #GoanCuisine #Panjim',
        locationTag: 'Panjim, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[1]._id,
      ...
      },
      {
        userId: createdUsers[15]._id,
        type: 'Post',
        text: 'Teaching salsa on Calangute Beach! Dance with the waves 💃 #Dance #Salsa #Calangute',
        locationTag: 'Calangute, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      
      // Photography and Art Posts
      {
        userId: createdUsers[8]._id,
        type: 'Post',
      ...
      },
      {
        userId: createdUsers[18]._id,
        type: 'Post',
        text: 'Teaching water sports at Colva today! The waves are perfect for beginners 🏄‍♂️ #WaterSports #Teaching #Colva',
        locationTag: 'Colva, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      ...
      // More diverse posts
      {
        userId: createdUsers[0]._id,
        type: 'Post',
        text: 'Found the best beach shack in Calangute! Fresh seafood and cold beer 🍺 #BeachShack #Seafood #Calangute',
        locationTag: 'Calangute, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[2]._id,
        type: 'Post',
        text: 'Anjuna flea market has the coolest vintage finds! Perfect for unique souvenirs 🛍️ #FleaMarket #Vintage #Anjuna',
        locationTag: 'Anjuna, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[4]._id,
        type: 'Post',
        text: 'Tried authentic Goan vindaloo today! The spice level is perfect 🔥 #Vindaloo #Spicy #GoanFood',
        locationTag: 'Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[7]._id,
        type: 'Post',
        text: 'Solo sunset at Palolem Beach. Sometimes the best company is yourself 🌅 #SoloTravel #Sunset #Palolem',
        locationTag: 'Palolem, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[9]._id,
        type: 'Post',
        text: 'Beach volleyball tournament at Candolim! The energy is amazing 🏐 #Volleyball #BeachSports #Candolim',
        locationTag: 'Candolim, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[11]._id,
        type: 'Post',
        text: 'Art gallery opening in Fontainhas tonight! Local artists showcasing their work 🎨 #ArtGallery #LocalArt #Fontainhas',
        locationTag: 'Fontainhas, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[13]._id,
        type: 'Post',
        text: 'Meditation session in Assagao forest. The sounds of nature are so peaceful 🌿 #Meditation #Nature #Assagao',
        locationTag: 'Assagao, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[15]._id,
        type: 'Post',
        text: 'Salsa night at Calangute Beach! Dancing under the stars is magical 💃 #Salsa #BeachDance #Calangute',
        locationTag: 'Calangute, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[17]._id,
        type: 'Post',
        text: 'Cooking class in Panjim today! Learning the secrets of Goan cuisine 👩‍🍳 #CookingClass #GoanCuisine #Panjim',
        locationTag: 'Panjim, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      },
      {
        userId: createdUsers[19]._id,
        type: 'Post',
        text: 'Beach conservation workshop at Patnem! Education is key to protecting our oceans 🌊 #Conservation #Education #Patnem',
        locationTag: 'Patnem, Goa',
        timestamp: new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000)
      }
    ];
    ...
    const requests = [
      ...
      },
      {
        ...
        blockId: createdBlocks[9]._id,
        status: 'Accepted',
        message: 'Would love to join the yoga session!'
      },
      {
        senderId: createdUsers[7]._id,
        receiverId: createdUsers[2]._id,
        blockId: createdBlocks[6]._id,
        status: 'Pending',
        message: 'Want to learn surfing!'
      },
      {
        senderId: createdUsers[9]._id,
        receiverId: createdUsers[18]._id,
        blockId: createdBlocks[19]._id,
        status: 'Accepted',
        message: 'Interested in water sports!'
      },
      {
        senderId: createdUsers[11]._id,
        receiverId: createdUsers[8]._id,
        blockId: createdBlocks[17]._id,
        status: 'Pending',
        message: 'Love photography, can I join?'
      },
      {
        senderId: createdUsers[15]._id,
        receiverId: createdUsers[5]._id,
        blockId: createdBlocks[14]._id,
        status: 'Pending',
        message: 'Want to learn salsa!'
      },
      {
        senderId: createdUsers[16]._id,
        receiverId: createdUsers[19]._id,
        blockId: createdBlocks[18]._id,
        status: 'Accepted',
        message: 'Marine biology interests me!'
      }
    ];
    ...
    console.log('\n🌍 All users are visible on the map and in the feed!');
